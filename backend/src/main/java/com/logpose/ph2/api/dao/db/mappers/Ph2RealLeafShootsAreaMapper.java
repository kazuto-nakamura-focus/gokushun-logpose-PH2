...
public interface Ph2RealLeafShootsAreaMapper
	 ...
	 * @mbg.generated
	 */
	int deleteByPrimaryKey(@Param("deviceId") Long deviceId, @Param("targetDate") Date targetDate);
	 ...
	 * @mbg.generated
	 */
	Ph2RealLeafShootsAreaEntity selectByPrimaryKey(@Param("deviceId") Long deviceId,
	 ...
	 * @mbg.generated
	 */
	int updateByPrimaryKeySelective(Ph2RealLeafShootsAreaEntity row);
